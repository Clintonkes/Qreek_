  ...
  const handlePrint = () => {
    ...
    win.document.write(`
      ...
      <div class="totals">
        ...
        <div class="total-box"><div style="color:#666;font-size:0.75rem">Fee (0.15%)</div><strong style="color:#c00">${FMT(run.total_fee)}</strong></div>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '1rem', marginBottom: '1.75rem' }}>
          {[
            ...
            ['Fee (0.15%)', FMT(run.total_fee), 'var(--text-2)'],
